        ...
        <div class="col-12 col-md-3">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="color-bleu">GRIS</label>
                            </div>
                        </li>
                        <li class="list-group-item">
                            <div class="form-check">
                                <input type="checkbox" name="color[]" value="rouge" class="form-check-input" id="color-red">
                                <label class="form-check-label" for="color-red">Noir</label>
                            </div>
                        </li>
                        <li class="list-group-item">
                            <div class="form-check">
                                <input type="checkbox" name="color[]" value="vert" class="form-check-input" id="color-vert">
                                <label class="form-check-label" for="color-vert">Blanc</label>
                            </div>
                        </li>
                        <li class="list-group-item">
            ...
            <div class="card bg-light mb-3">
                ...
                <ul class="list-group category_block">
                    <li class="list-group-item"><a href="category.html">Informatique</a></li>
                    <li class="list-group-item"><a href="category.html">Téléphonie</a></li>
                    <li class="list-group-item"><a href="category.html">Jeux Vidéos</a></li>
                </ul>
            </div>
            <div class="card bg-light mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <p class="btn btn-danger w-100">{{ $produits->prix}} &euro;</p>
                        </div>
                        <div class="col">
